...
void P1R_Path::Initialize() {
	std::cout << "P1 Right!" << std::endl;
	Robot::motionProfile->initMotionProfile();
	Robot::motionProfile->startFilling(kP1Right_leftprofile, kP1Right_rightprofile, kP1RightSz);
}

// Called repeatedly when this Command is scheduled to run
void P1R_Path::Execute() {
